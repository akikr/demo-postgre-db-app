...
class BookmarkControllerIntegrationTest extends PostgreTestContainer {
    ...
    void testGetAllBookmarks() throws Exception {
        ...
        mockMvc.perform(get("/v1/bookmarks").param("page", "0").param("size", "10"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data").isArray());
    }
    ...
    void testCreateBookmark() throws Exception {
        mockMvc.perform(post("/v1/bookmarks").contentType("application/json").content("""
                        {
                          "title":"Test",
                          "url":"https://test.com"
                        }
    ...
    void testUpdateBookmark() throws Exception {
        mockMvc.perform(put("/v1/bookmarks").contentType("application/json").content("""
                        {
                          "id":"1",
                          "title":"Test3",
                          "url":"https://test3.com"
