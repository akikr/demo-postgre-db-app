...
class BookmarkControllerWithRestTestClientTest {
    ...
    void getAllBookmarks() {
        ...
        // Arrange
        Map<String, Object> dataWithPagination =
                Map.of("data", List.of(new Bookmark(102L, "Test-Title", "https://test-url", LocalDateTime.now())));

        // Mock
        when(bookmarkService.getAllBookmarks(anyInt(), anyInt()))
                .thenReturn(ResponseEntity.ok().body(dataWithPagination));
